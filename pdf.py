...
def reportPDFView(request):
    ...
    for ik in o['host']:
        ...
        if i['status']['@state'] == 'up':
            hostdetails_html += '<div class="row margintb">' + \
                ...
                hostcounters['po'] + hostcounters['pc'] + hostcounters['pf']) + '</h3>TOTAL PORT</center></div>' + \
                ...
                hostcounters['pc']) + '</h3>CLOSED PORT</center></div>' + \
    ...
    r[
        ...
        counters['pc'] + counters['po'] + counters['pf']) + '</span></div>' + \
        ...
        counters['pc'] + counters['po'] + counters['pf']) + '</span><br><br>' + \
    ...
    r['html'] += '' + \
                 ...
                 '			<a href="https://gitlab.com/hweckermann/proteciotnet">https://gitlab.com/hweckermann/proteciotnet</a>' + \
                 '		</div>' + \
                 '	</div>' + \
                 '</div>'
